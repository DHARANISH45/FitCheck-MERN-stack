    ...
    <form
        ...
        {bmr && (
          <div className="result mt-6">
            ...
            <p className="text-white">BMR: {bmr.toFixed(2)} kcal/day</p>
            <p className="text-white">TDEE: {tdee.toFixed(2)} kcal/day</p>
            <p className="mt-4 text-white">To maintain your weight: {tdee.toFixed(2)} kcal/day</p>
            <p className="text-white">To lose weight (deficit of 500 kcal/day): {(tdee - 500).toFixed(2)} kcal/day</p>
            <p className="text-white">To gain weight (surplus of 500 kcal/day): {(tdee + 500).toFixed(2)} kcal/day</p>
          </div>
        )}
    </div>
    </div>
